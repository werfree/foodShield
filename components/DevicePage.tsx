  ...
  return (
    <PressableOpacity style={styles.itemContainer} onPress={onPress}>
      <View style={styles.horizontal}>
        ...
        <Text
          style={{...globalStyle.text, ...styles.deviceName}}
          numberOfLines={3}>
          {device.name}{' '}
          <Text style={styles.devicePosition}>({device.position})</Text>
        </Text>
      </View>
      <Text style={{...globalStyle.text, ...styles.deviceTypes}}>
        {deviceTypes}
      </Text>
      <View style={styles.horizontal}>
      ...
      <Text
        style={{...globalStyle.text, ...styles.deviceId}}
        numberOfLines={2}
...
type Props = NativeStackScreenProps<Routes, 'DevicesPage'>;
const DevicesPage = ({navigation}: Props): React.ReactElement => {
    ...
    ({section}: {section: SectionData}) => {
      ...
      return (
        <View style={styles.sectionHeader}>
          <Text style={{...globalStyle.text, ...styles.sectionHeaderText}}>
    ...
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <View style={styles.horizontal}>
          ...
          <Text style={{...globalStyle.text, ...styles.header}}>
            Camera Devices
          </Text>
        </View>
        <Text style={{...globalStyle.text, ...styles.subHeader}}>
